(() => {
  ...
  var UUIDS = {
    ...
    steps: "0000fee0-0000-1000-8000-00805f9b34fb",
  ...
  var MiBand6 = class {
    ...
    async init() {
      ...
      this.chars.steps = await this.services.steps.getCharacteristic(CHAR_UUIDS.steps);
    ...
    async measureSteps() {
      ...
      await this.startNotifications(this.chars.steps, (e) => {
        ...
        window.dispatchEvent(new CustomEvent("steps", {
          detail: stepsDifference
        }));
        this.previousSteps = currentSteps;
      });
      this.stepsTimer = this.stepsTimer || setInterval(() => {
